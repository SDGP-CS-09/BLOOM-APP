...
// Define a map to store plant names and their corresponding image URLs
final Map<String, String> plantImages = {
  'tomato': 'https://example.com/tomato.jpg',
  'potato': 'https://example.com/potato.jpg',
  'chilli': 'https://example.com/chilli.jpg',
  'bellpepper': 'https://example.com/bellpepper.jpg',
  'corn': 'https://example.com/corn.jpg',
  'eggplant': 'https://example.com/eggplant.jpg',
};

class PlantDetailScreen extends StatelessWidget {
  final String commonName;
  final String scientificName;
  // Remove imageUrl parameter since we'll determine it dynamically
  ...
  Widget build(BuildContext context) {
    // Get the image URL dynamically based on the commonName
    final String imageUrl = plantImages[commonName.toLowerCase()] ?? 'https://example.com/default_plant.jpg';
