...
class _ScheduleScreenState extends State<ScheduleScreen> {
  ...
  Future<void> _fetchSchedules() async {
    ...
    final Map<dynamic, dynamic> plants =
          ...
          try {
            ...
            if (scheduleDate.isBefore(
              ...
              groupedSchedules.putIfAbsent(date, () => []).add({
                ...
                'plantImage':
                    'assets/${plantData['name'].toString().toLowerCase()}.jpg',
  ...
  void _editSchedule(
      String plantKey, String scheduleKey, String currentDate) async {
  ...
  Widget _buildScheduleList() {
    ...
    return ListView(
      ...
      children: filteredSchedules.entries
          .map((entry) => Column(
